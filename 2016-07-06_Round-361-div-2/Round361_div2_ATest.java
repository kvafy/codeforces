...
public class Round361_div2_ATest {
    ...
    public void solve() throws Exception {
        ...
        for (int i = 0 ; i < tests.length ; i++) {
            ...
            Round361_div2_A.FastReader in = new Round361_div2_A.FastReader(new ByteArrayInputStream(tests[i][0].getBytes()));
            PrintWriter out = new PrintWriter(actualOut);

            Round361_div2_A.solve(in, out); // kept static to avoid "push this" overhead on method calls
