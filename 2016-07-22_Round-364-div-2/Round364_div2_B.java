...
public class Round364_div2_B {
    ...
    public static void solve(FastReader in, PrintWriter out) {
        int n = in.readInt();
        int rooks = in.readInt();

        Set<Integer> safeRows = IntStream.rangeClosed(1, n)
                .mapToObj(Integer::valueOf)
                .collect(Collectors.toSet());
        Set<Integer> safeCols = IntStream.rangeClosed(1, n)
                .mapToObj(Integer::valueOf)
                .collect(Collectors.toSet());
        ...
        for (int i = 0 ; i < rooks ; i++) {
            ...
            safeRows.remove(r);
            safeCols.remove(c);
            out.println(((long) safeRows.size()) * ((long) safeCols.size()));
        }
    }
