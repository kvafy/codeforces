...
public class Round355_C_postContest {

    private static final long MOD_10e9_PLUS_7 = 1_000_000_007L;
    ...
    public static void main(String[] args) throws IOException {
        ...
        long solution = 1; // PERFORMANCE: use long with modulo instead of BigInteger
        for (int i = 0 ; i < s.length() ; i++) {
            int n = toBase64(s.charAt(i));
            solution = (solution * possibilities(n)) % MOD_10e9_PLUS_7;
        }
