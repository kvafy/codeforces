...
public class Round370_div2_BTest {
    ...
    public void solve() throws Exception {
        ...
        for (int i = 0 ; i < tests.length ; i++) {
            ...
            Round370_div2_B.FastReader in = new Round370_div2_B.FastReader(new ByteArrayInputStream(tests[i][0].getBytes()));
            PrintWriter out = new PrintWriter(actualOut);

            Round370_div2_B.solve(in, out); // kept static to avoid "push this" overhead on method calls
