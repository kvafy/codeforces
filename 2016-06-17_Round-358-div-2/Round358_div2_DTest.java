...
public class Round358_div2_DTest {
    ...
    public void solve() throws Exception {
        ...
        for (int i = 0 ; i < inputs.length ; i++) {
            ...
            Round358_div2_D.FastReader in = new Round358_div2_D.FastReader(new ByteArrayInputStream(inputs[i].getBytes()));
            PrintWriter out = new PrintWriter(actualOut);

            Round358_div2_D.solve(in, out); // kept static to avoid "push this" overhead on method calls
